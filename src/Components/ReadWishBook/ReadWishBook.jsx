    ...
    return (
        <div className="card lg:card-side bg-base-100 shadow-xl">
            ...
            <div className="card-body space-y-2">
                ...
                <hr className='mt-3' />
                <div className='font-sans-s space-x-3 space-y-3'>
                    <button disabled className='bg-blue-100 font-semibold text-blue-600 px-3 py-2 rounded-3xl'>Category: {category}</button>
                    <button disabled className='bg-orange-100 font-semibold text-orange-600 px-3 py-2 rounded-3xl'>Rating: {rating}</button>
                    <Link to={`/details/${bookId}`}>
                        <button className='bg-primary-color-c font-semibold text-white px-3 py-2 rounded-3xl'>View Details</button>
                    </Link>
                </div>
            </div>
        </div>
